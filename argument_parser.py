...
def parse_args():
    ...
    parser.add_argument('-v', '--verbose', action='count', default=0, help='Increase verbosity (-v for errors, -vv for warnings, -vvv for debug)')
    
    # Only return contributors from adversarial countries
    parser.add_argument('--adversarial', action='store_true', help='Only return contributors from adversarial countries')
